...
<pre><code>
&#60;!-- <span class="jobTitle">La plupart des structures des sites 
    (hors Wordpress) favorisent le référencement 
...
<pre><code>
      ...
      une <span class="vocabularyLevel3">maquette</span> tierce fournie par le client;
...
<pre><code>
      ...
      aspect visuel claqué sur une application tierse
      obsolète;
...
<pre><code>
      ...
      <span class="vocabularyLevel3">maquette</span> fournie par un <span class="jobTitle">infographiste</span>;
