...
<pre class="codeNumbers"><code>  22
  ...
  26
    ...
    <pre><code>
      <span class="vocabularyLevel1">Customization</span> de la structure d'un <span class="vocabularyLevel1">thème bootstrap</span> en fonction d'images et 
         de textes (fournis ou <span class="vocabularyLevel1">dynamiques</span>)
      Idem l. 13 <?php include('bookmark_level1.svg') ?>
...
<pre class="codeNumbers"><code>  37
  ...
  40
    ...
    <pre><code>
      Utilisation de la <span class="vocabularyLevel3">bibliothèque</span> <span class="vocabularyLevel1">CSS</span> de <span class="vocabularyLevel1">Qt</span> pour un aspect visuel claqué sur une 
