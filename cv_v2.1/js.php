...
<pre class="codeNumbers"><code>   8
 ...
 <pre><code>
      <span class="setBookmark"><?php include('bookmark_level3.svg') ?></span>Récupération et personnalisation de <span class="vocabularyLevel2">scripts</span> tiers et fournis avec le <span class="vocabularyLevel2">package</span>
         du thème
      <span class="setBookmark"><?php include('bookmark_level4.svg') ?></span>Création et archivage de <span class="vocabularyLevel2">scripts</span> maison proposés au client dans le respect 
         des animations des thèmes embarquées ou fournies par la <span class="vocabularyLevel2">charte</span>
      ...
      <span class="setBookmark"><?php include('bookmark_level2.svg') ?></span><span class="vocabularyLevel1">Bootstrap</span> : choix d'une version de <span class="vocabularyLevel1">JQuery</span> récente compatible avec la version 
         du <span class="vocabularyLevel2">package</span>
...
<pre><code>
      ...
      Idem l. 13 <?php include('bookmark_level1.svg') ?>
    </code></pre>
<!------------------------------------ Odilezen ------------------------------------>
    <blockquote class="geekItem blockquote autoentrepreneuriat">
...
<pre class="codeNumbers"><code>  24
  ...
  <pre><code>
      Idem l. 9 <?php include('bookmark_level3.svg') ?>
      Idem l. 11 <?php include('bookmark_level4.svg') ?>
      Idem l. 13 <?php include('bookmark_level1.svg') ?>
      Idem l. 14 <?php include('bookmark_level2.svg') ?>
  </code></pre>
<!------------------------------------ Hôtel les pins ------------------------------------>
<blockquote class="geekItem blockquote autoentrepreneuriat">
...
<pre class="codeNumbers"><code>  31
  ...
  35
    ...
    <pre><code>
      <span class="vocabularyLevel1">JS Hack</span> pour ajustement graphique selon l'appareil et le navigateur utilisés
      Idem l. 11 <?php include('bookmark_level4.svg') ?>
      Idem l. 14 <?php include('bookmark_level2.svg') ?>
    </code></pre>
<!------------------------------------ Mais aussi ------------------------------------>
<blockquote class="geekItem blockquote all-colors-gradient">
<pre>  36 # **Too much is not enough !**</pre>
</blockquote>
<pre class="codeNumbers" ><code class="medley">  37
  38
  39
  40
  41
